# style.py (АКТУАЛЬНАЯ ВЕРСИЯ: Темный фон, увеличенный шрифт поиска, Скроллбар соответствует футеру)
...
def apply_dark_theme(app):
    ...
    QWidget#centralwidget {{
        ...
        /* 🔴 ФИКС: Добавляем фоновый цвет, чтобы скрыть прозрачность окна */
   ...
   QScrollArea {{ 
    ...
    QScrollBar:vertical {{
        ...
        background: #1a1a1a; 
        width: 10px;
        /* 🟢 ИЗМЕНЕНИЕ: Убираем маржины, чтобы скроллбар прилегал к Title Bar и Footer */
        margin: 0px 0 0px 0; 
    }}
